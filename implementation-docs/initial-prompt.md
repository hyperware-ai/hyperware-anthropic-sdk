...
## Hyperware Anthropic API library
...
Create an implementation plan for a Rust library for Hyperware processes to access the anthropic API

Above are docs for the anthropic api message format and hyperware HTTP client methods. Use the Hyperware HTTP client methods to talk to the Anthropic API. Do not use ever use streaming mode. Do enable tool use
